...
public class formProduk extends javax.swing.JPanel {
    ...
    private final tabelProduk produk = new tabelProduk();
    private final produkServis servis = new produkDao();
    
    public formProduk() {
        initComponents();
        tblData.setModel(produk);
        loadData();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dashboard > Produk ");
    ...
    private void pencarianData(){
        List<dataProduk> list = servis.pencarianData(txtPencarian.getText());
        produk.setData(list);
    }

    private void tambahData() {
        formTambahProduct formInput = new formTambahProduct(null, true, 1, null);
    ...
    private void perbaruiData() {
        ...
        if(row != -1){
            dataProduk Produk = produk.getData(row);
            formTambahProduct formInput = new formTambahProduct(null, true, row, Produk);
            formInput.setVisible(true);
            loadData();
        }else{
